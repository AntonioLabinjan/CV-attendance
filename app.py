# NAPRAVIT DA SE ZA SVAKI PREDMET PRISUTNOST MORE PRIJAVIT OD DO I UBACIT KAŠNJENJE
# FUNKCIJA => SET CURRENT LOGGING SUBJECT. STAVIMO DATE, STARTTIME, ENDTIME I OSTALO PUSTIMO ISTO (funkcija već postoji, samo triba dodat time interval)
# NE MORAN SE ZAJEBAVAT S TIN DA ODREĐENI STUDENT MORA IMAT DEFINIRANE PREDMETE KOJE SLUŠA, JER I ONAKO MORAŠ BIT FIZIČKI TAMO ZA FACE SCAN
import os
import cv2
import numpy as np
